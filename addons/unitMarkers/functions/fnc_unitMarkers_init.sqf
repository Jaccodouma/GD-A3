...
action_unitMarkers_Off = ["BFT_unitMarkers_Off", "Disable unit marker", getText(configfile >> "TCA_BFT_Interact_Icons" >> "off"), {player setVariable ["BFT_playerMarker_visible", false, true]}, {GVAR(unitMarkers_showToggle) && visibleMap && player getVariable ["BFT_playerMarker_visible", true]}] call ace_interact_menu_fnc_createAction;
